...
from models import TechOutputGuardRailOutput, AccountOutputGuardRailOutput, OrderOutputGuardRailOutput, BillOutputGuardRailOutput,UserAccountContext
...
technical_output_guardrail_agent= Agent(
    ...
    """,
    output_type=TechOutputGuardRailOutput,
)
...
async def technical_output_guardrail(
    ...
    result= await Runner.run(technical_output_guardrail_agent,
                             output,
                             context=wrapper.context)
    validation = result.final_output

    triggered = validation.contains_off_topic or validation.contains_billing_data or validation.contains_order_data or validation.contains_account_data
